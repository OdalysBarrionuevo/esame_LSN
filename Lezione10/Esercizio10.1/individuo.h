...
public:
    ...
    void SetVector (vector<int> vec){individuo = vec;};//setto il vettore individuo con un dato vettore
    int GetValue(int index){return individuo[index];};//Estraggo il valore della posizione index di un individuo
    vector <int> Get_listCities();//lista di interi di individuo
    //Mutazioni
