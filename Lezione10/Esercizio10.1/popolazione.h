...
private:
    ...
    void InitializePopolazione(Random& rnd); //usato dal costruttore per inizializzare



public:
    Popolazione(int size, Random& rnd); //costruttore di una popolazione
    ...
    void Set_Individuo(std::vector<int> vec, int index);//Aggiungo un individuo alla popolazione alla posizione index
